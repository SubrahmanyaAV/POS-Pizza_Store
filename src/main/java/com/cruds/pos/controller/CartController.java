...
*/	
	@RequestMapping(value="addtocart.html", method=RequestMethod.GET)
	public String addCart(@RequestParam("foodID") String foodID
						 ,@RequestParam("name") String name
					     ,@RequestParam("foodtype") String foodtype
					     ,@RequestParam("foodSize") String foodSize
					     ...
					     ,HttpSession session)
	{
		...
		cart.add(new FoodBean(foodID, name, foodtype, foodSize, foodQuantity, price));
		System.out.println(cart);
		session.setAttribute("CART", cart);
		session.setAttribute("foodID",foodID );
		session.setAttribute("name",name );
		session.setAttribute("foodtype",foodtype );
		session.setAttribute("foodSize", foodSize);
		session.setAttribute("foodQuantity",foodQuantity );
